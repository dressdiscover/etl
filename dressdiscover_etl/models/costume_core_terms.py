...
CC00009 = CostumeCoreTerm(
    ...
    image_rights=CostumeCoreRights(
        author="Royal Armoury",
        license_uri="https://creativecommons.org/publicdomain/zero/1.0/",
        rights_statement_uri=None,
        source_name="Wikimedia Commons",
        source_url="https://commons.wikimedia.org/wiki/File:Gustav_II_Adolfs_sveptr%C3%B6ja_-_svepdr%C3%A4kt_-_Livrustkammaren_-_61164.tif",
    ),
    wikidata_id=None,
)
...
CC00037 = CostumeCoreTerm(
    ...
    image_rights=CostumeCoreRights(
        author="Flickr user Abhisit Vejjajiva",
        license_uri="https://creativecommons.org/licenses/by/2.0/",
        rights_statement_uri=None,
        source_name="Flickr",
        source_url="https://commons.wikimedia.org/wiki/File:File-Abhisit_Vejjajiva_2_October_2009_cropped.jpg",
    ),
...
CC00098 = CostumeCoreTerm(
    ...
    image_rights=CostumeCoreRights(
        ...
        license_uri="https://rightsstatements.org/vocab/NKC/1.0/",
        rights_statement_uri=None,
        source_name="Wikimedia Commons",
...
CC00349 = CostumeCoreTerm(
    ...
    image_rights=CostumeCoreRights(
        author="Vassar College Costume Collection",
        license_uri="https://rightsstatements.org/vocab/InC-EDU/1.0/",
        rights_statement_uri=None,
        source_name="Vassar College Costume Collection",
        source_url="http://vcomeka.com/vccc/items/show/5066",
    ),
    wikidata_id=None,
)
